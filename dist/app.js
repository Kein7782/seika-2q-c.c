...
// const stageAnimation = anime.timeline({
	...
	(0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
		...
		delay: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].stagger(200, {grid: [14, 5], from: 'center'}),
		endDelay: 1000,
		// translateX: anime.stagger(10, {grid: [14, 5], from: 'center', axis: 'x'}),
  		// translateY: anime.stagger(10, {grid: [14, 5], from: 'center', axis: 'y'}),
  		// rotateZ: anime.stagger([0, 90], {grid: [14, 5], from: 'center', axis: 'x'}),
		...
		// translateX:() => anime.random(-200, 200),
		rotateZ: [
			animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].stagger([0, 90], {grid: [14, 5], from: 'center', axis: 'x'}),
			],

		translateX:[
			{value: () => animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(-180, 180), easing: 'easeOutSine', duration: 500},
			{value: 0, easing: 'easeInOutQuad', duration: 1200},
			],
		translateY:[
			() => animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(-180, 180),
