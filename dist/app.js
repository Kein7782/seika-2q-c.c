...
// const stageAnimation = anime.timeline({
	(0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
		...
		endDelay: 1000,
		translateX: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].stagger(10, {grid: [14, 5], from: 'center', axis: 'x'}),
  		translateY: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].stagger(10, {grid: [14, 5], from: 'center', axis: 'y'}),
  		rotateZ: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].stagger([0, 90], {grid: [14, 5], from: 'center', axis: 'x'}),
  		easing: 'easeInOutQuad',
		translateX:() => animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(-200, 200),
		translateY:() => animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(-200, 200),
